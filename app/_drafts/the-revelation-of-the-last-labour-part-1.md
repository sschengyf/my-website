...
自从John McCarthy在1950年代首次提出AI这个抽象概念，70年过去，AI终于成为人人都在讨论和使用的工具。假如John McCarthy穿越到2026年，我挺好奇他将怎么评价如今的AI。但有一点他大概会认同，AI本质上是让人类更方便的使用计算资源。

杰弗里·辛顿 (Geoffrey Hinton)和约翰·霍普菲尔德（John Hopfield）“因为他们的基础性发现与发明，让人工神经网络能够应用于机器学习。”获得2024年诺贝尔物理学奖。有意思的是，他们的研究并非发现了新的物理法则，而是他们开创性的把物理学的概念应用到了计算机世界来处理数据，原子自旋理论，物理系统的总能量，热力学系统，玻尔兹曼分布与温度。他们证明了，只要给数据通上电，给网络定好能量函数，虚拟的数据矩阵就会遵循热力学和统计力学的物理规律，自己“涌现”出智慧。

而作为普通用户的我，感觉AI更像一个聪明的操作系统。过去人们想使用计算资源，从最开始的大型计算机，每个使用者都要自己写程序，快进到个人电脑，通常是先安装一个基础的操作系统，然后在此之上安装一些别人开发的特定软件来处理特定需求或者有编程能力的人会自己开发一些软件来使用，即使后来出现了各种互联网应用（SaaS），打开浏览器便能使用，但仍有不低的使用门槛，私人定制化程度也不高。现在有了AI，不论你是通过打字还是语音还是指挥AI agent
