...
所谓机器学习，简单来说就是让机器使用算法去学习我们提供的训练数据从而寻找数据里的规律（pattern），然后让机器用找到的规律来识别新的数据并做出预测和判断。这样做相较于一般的基于规则编写的计算机程序，虽然牺牲了一些准确性，但得到了更好的适应性，在现实世界里，很多场景是不可能完全靠人力来提前预设所有变量并制定相应规则，图像识别是一个经典的例子。
...
这套神经网络的基本原理在 1970 年代便存在了，在 1980 年代由 David Rumelhart, Geoffrey Hinton, Ronald Williams 的推动被主流接受。
